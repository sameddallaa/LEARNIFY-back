...
urlpatterns = [
    ...
    path('ressources/td/<int:subject>/<int:chapter>/<int:td>/delete/', view=views.ChapterTDDeleteView.as_view(), name='CoursDeleteView'),
    path('ressources/tp/<int:subject>/<int:chapter>/<int:tp>/delete/', view=views.ChapterTPDeleteView.as_view(), name='CoursDeleteView'),
    path('ressources/homework/<int:subject>/<int:chapter>/<int:homework>/delete/', view=views.ChapterHomeworkDeleteView.as_view(), name='CoursDeleteView'),
